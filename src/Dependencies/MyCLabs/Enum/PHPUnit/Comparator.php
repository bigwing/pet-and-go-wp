...
namespace BigWing\PetAndGo\Dependencies\MyCLabs\Enum\PHPUnit;
 ...
 *
 * \SebastianBergmann\Comparator\Factory::getInstance()->register(new \BigWing\PetAndGo\Dependencies\MyCLabs\Enum\PHPUnit\Comparator());
 */
