...
use BigWing\PetAndGo\Dependencies\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use BigWing\PetAndGo\Dependencies\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use BigWing\PetAndGo\Dependencies\Monolog\Logger;
use BigWing\PetAndGo\Dependencies\Monolog\ResettableInterface;
 ...
 * BigWing\PetAndGo\Dependencies\Monolog\Handler\FingersCrossed\ namespace.
 *
...
class FingersCrossedHandler extends Handler implements ProcessableHandlerInterface, ResettableInterface, FormattableHandlerInterface
{
    ...
    public function __construct($handler, $activationStrategy = null, int $bufferSize = 0, bool $bubble = true, bool $stopBuffering = true, $passthruLevel = null)
    {
        ...
        if (!$this->handler instanceof HandlerInterface && !is_callable($this->handler)) {
            throw new \RuntimeException("The given handler (".json_encode($this->handler).") is not a callable nor a BigWing\PetAndGo\Dependencies\Monolog\Handler\HandlerInterface object");
        }
    }
