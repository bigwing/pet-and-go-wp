 ...
 *
 *      $logger = new \BigWing\PetAndGo\Dependencies\Monolog\Logger('all', array(new \BigWing\PetAndGo\Dependencies\Monolog\Handler\PHPConsoleHandler()));
 *      \BigWing\PetAndGo\Dependencies\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['BigWing\PetAndGo\Dependencies\Monolog\\'], // array Hide calls of classes started with...
    ...
    /**
     * @param  array             $options   See \BigWing\PetAndGo\Dependencies\Monolog\Handler\PHPConsoleHandler::$options for more details
