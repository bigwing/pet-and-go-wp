...
namespace BigWing\PetAndGo\Dependencies\Monolog\Handler\FingersCrossed;
...
class ChannelLevelActivationStrategy implements ActivationStrategyInterface
{
    ...
    public function __construct($defaultActionLevel, array $channelToActionLevel = [])
    {
        ...
        $this->channelToActionLevel = array_map('BigWing\PetAndGo\Dependencies\Monolog\Logger::toMonologLevel', $channelToActionLevel);
    }
